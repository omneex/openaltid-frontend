<template>
  <div class="flex flex-col gap-2 max-w-xs lg:max-w-3xl mx-auto">
    <h1 class="text-4xl">
    ...
    <p>
      ...
      when you visit
      <span class="font-bold">{{ store.state.siteTitle }}</span> (the “Site”).
    </p>

    <h2 class="text-3xl">Personal Information We Collect</h2>
    ...
    <h3 class="text-2xl">We collect Device Information using the following technologies:</h3>
    ...
    <p>
      ...
      visit
      <a href="https://www.allaboutcookies.org">http://www.allaboutcookies.org</a>.
    </p>
    <p>
    ...
    <p>
      - “Discord connections” are the IDs and Types of connections that you have connected to your
      Discord account.
    </p>

    <h2 class="text-3xl">How Do We Use Your Personal Information?</h2>

    <p>
      Your Discord connections will be used to test against a database of other connections to
    ...
    <h2 class="text-3xl">Data Retention</h2>
    <p>
      When login and verify through our website your data will be kept for our records unless and
      until you ask us to delete this information.
    </p>

    <h2 class="text-3xl">Minors</h2>
    <p>The Site is not intended for individuals under the age of 18.</p>

    <h2 class="text-3xl">Changes</h2>
    <p>
    ...
    <p>
      ...
      to make a complaint, please contact us by e-mail at {{ store.state.SUPPORT_EMAIL }}
    </p>
  </div>
</template>
